...
interface TenantState {
  ...
  updateTenant: (data: { name?: string; defaultSessionTimeoutSeconds?: number; mfaRequired?: boolean; vaultAutoLockMaxMinutes?: number | null; enforcedConnectionSettings?: EnforcedConnectionSettings | null }) => Promise<void>;
